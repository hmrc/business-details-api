...
trait MockRetrieveAccountingTypeValidatorFactory extends MockValidatorFactory[RetrieveAccountingTypeRequest] {

  val mockRetrieveAccountingTypeValidatorFactory: RetrieveAccountingTypeValidatorFactory =
    mock[RetrieveAccountingTypeValidatorFactory]
