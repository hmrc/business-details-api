...
trait MockRetrievePeriodsOfAccountValidatorFactory extends MockValidatorFactory[RetrievePeriodsOfAccountRequest] {

  val mockRetrievePeriodsOfAccountValidatorFactory: RetrievePeriodsOfAccountValidatorFactory = mock[RetrievePeriodsOfAccountValidatorFactory]
