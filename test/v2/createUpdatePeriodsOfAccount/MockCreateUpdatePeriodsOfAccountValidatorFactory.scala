...
trait MockCreateUpdatePeriodsOfAccountValidatorFactory extends MockValidatorFactory[CreateUpdatePeriodsOfAccountRequest] {

  val mockCreateUpdatePeriodsOfAccountValidatorFactory: CreateUpdatePeriodsOfAccountValidatorFactory =
    mock[CreateUpdatePeriodsOfAccountValidatorFactory]
