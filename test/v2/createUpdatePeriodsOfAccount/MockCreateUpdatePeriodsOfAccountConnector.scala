...
trait MockCreateUpdatePeriodsOfAccountConnector extends MockFactory {
  ...
  object MockedCreateUpdatePeriodsOfAccountConnector {
    ...
    def create(requestData: CreateUpdatePeriodsOfAccountRequestData): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (
        mockCreateUpdatePeriodsOfAccountConnector
          .create(_: CreateUpdatePeriodsOfAccountRequestData)(
            _: HeaderCarrier,
            _: ExecutionContext,
            _: String
          )
