...
import v1.retrieveBusinessDetails.model.response.downstream.{LatencyDetails, LatencyIndicator, QuarterReportingType, QuarterTypeElection}
import v1.retrieveBusinessDetails.model.response.{AccountingPeriod, RetrieveBusinessDetailsHateoasData, RetrieveBusinessDetailsResponse}
