...
class ListAllBusinessesMockValidator extends MockFactory {

  val mockValidator: ListAllBusinessesValidator = mock[ListAllBusinessesValidator]

  object ListAllBusinessesMockValidator {

    def validate(data: ListAllBusinessesRawData): CallHandler1[ListAllBusinessesRawData, List[MtdError]] = {
      (mockValidator
