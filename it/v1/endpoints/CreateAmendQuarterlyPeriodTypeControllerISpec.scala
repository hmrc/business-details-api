    ...
    "return error according to spec" when {
      ...
      "downstream service error" when {
        ...
        val errors = List(
          ...
          (NOT_FOUND, "INCOME_SOURCE_NOT_FOUND", NOT_FOUND, RuleIncomeSourceNotFoundError),
          (CONFLICT, "INCOME_SOURCE_STATE_CONFLICT", BAD_REQUEST, RuleIncomeSourceStateConflictError),
          ...
          (UNPROCESSABLE_ENTITY, "INVALID_REQUEST_SUBMISSION", BAD_REQUEST, RuleIncomeSourceStateConflictError),
          (UNPROCESSABLE_ENTITY, "ANNUAL_INCOME_SOURCE", BAD_REQUEST, RuleIncomeSourceStateConflictError),
