...
import play.api.http.Status.{BAD_REQUEST, INTERNAL_SERVER_ERROR, NOT_FOUND, NO_CONTENT, UNPROCESSABLE_ENTITY}
import play.api.libs.json.Json
import play.api.libs.ws.{WSRequest, WSResponse}
import play.api.test.Helpers.AUTHORIZATION
import support.IntegrationBaseSpec

class WithdrawLateAccountingDateRuleControllerISpec extends IntegrationBaseSpec {
  ...
  private trait Test {
    ...
    private def mtdUri: String = s"/$nino/$businessId/$taxYear/late-accounting-date-rule-election/withdraw"
