...
@Singleton
class WithdrawLateAccountingDateRuleService @Inject() (connector: WithdrawLateAccountingDateRuleConnector) extends BaseService {

  def withdraw(request: WithdrawLateAccountingDateRuleRequest)(implicit ctx: RequestContext, ec: ExecutionContext): Future[ServiceOutcome[Unit]] =
