...
@Singleton
class WithdrawLateAccountingDateRuleConnector @Inject() (val http: HttpClientV2, val appConfig: AppConfig) extends BaseDownstreamConnector {

  def withdraw(request: WithdrawLateAccountingDateRuleRequest)(implicit
      hc: HeaderCarrier,
      ec: ExecutionContext,
