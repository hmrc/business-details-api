...
@Singleton
class DisapplyLateAccountingDateRuleController @Inject() (
    val authService: EnrolmentsAuthService,
    val lookupService: MtdIdLookupService,
    service: DisapplyLateAccountingDateRuleService,
    auditService: AuditService,
    validatorFactory: DisapplyLateAccountingDateRuleValidatorFactory,
    cc: ControllerComponents,
    val idGenerator: IdGenerator
)(implicit appConfig: AppConfig, ec: ExecutionContext)
    extends AuthorisedController(cc) {

  override val endpointName: String = "disapply-late-accounting-date-rule"

  implicit val endpointLogContext: EndpointLogContext =
    EndpointLogContext(controllerName = "DisapplyLateAccountingDateRuleController", endpointName = endpointName)
