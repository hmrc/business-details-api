...
@Singleton
class DisapplyLateAccountingDateRuleConnector @Inject() (val http: HttpClientV2, val appConfig: AppConfig) extends BaseDownstreamConnector {

  def disapply(request: DisapplyLateAccountingDateRuleRequest)(implicit
      hc: HeaderCarrier,
      ec: ExecutionContext,
