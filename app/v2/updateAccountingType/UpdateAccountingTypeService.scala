...
@Singleton
class UpdateAccountingTypeService @Inject() (connector: UpdateAccountingTypeConnector) extends BaseService {

  def update(request: UpdateAccountingTypeRequestData)(implicit ctx: RequestContext, ec: ExecutionContext): Future[ServiceOutcome[Unit]] =
