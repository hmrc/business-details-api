 ...
 * A tax year range.
 *
 * @param from the from date  (where YYXX-ZZ is translated to 20XX-04-06)
 * @param to the to date  (where YYXX-ZZ is translated to 20ZZ-04-05)
 */
...
object TaxYearRange {
   ...
   * @return a 1-year range e.g. 2017 to 2018
   */
