...
import v1.connectors.CreateAmendQuarterlyPeriodTypeConnector
...
class CreateAmendQuarterlyPeriodTypeService @Inject() (connector: CreateAmendQuarterlyPeriodTypeConnector) extends BaseService {
  ...
  private val downstreamErrorMap: Map[String, MtdError] =
    Map(
      ...
      "INCOME_SOURCE_NOT_FOUND"          -> RuleIncomeSourceNotFoundError,
      "INCOME_SOURCE_STATE_CONFLICT"     -> RuleIncomeSourceStateConflictError,
      ...
      "INVALID_REQUEST_SUBMISSION"       -> RuleIncomeSourceStateConflictError,
      "ANNUAL_INCOME_SOURCE"             -> RuleIncomeSourceStateConflictError,
